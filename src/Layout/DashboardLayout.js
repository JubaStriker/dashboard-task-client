    ...
    return (
        <>
            ...
            <div className='flex'>
                ...
                <aside id="sidebar-multi-level-sidebar" class="fixed md:top-[68px] lg:top-[77px] left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
                ...
                <div class="p-4 sm:ml-64 bg-gray-200 min-h-screen w-full">
